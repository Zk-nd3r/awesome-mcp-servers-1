...
- [zcash-mcp](https://github.com/Frontier-Compute/zcash-mcp) - Zcash privacy blockchain MCP server with 22 tools: shielded send, memo decode, attestation, proof verification, MPC wallets, cross-chain swaps
